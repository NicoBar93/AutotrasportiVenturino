<x-layout>
    ...
    <div class="container-fluid position-relative px-0">
        ...
        <button class="border-0 text-white fw-bold btnColor position-absolute p-2 top-0 end-0 mt-5 me-5 btnForMedia">RICHIEDI UN PREVENTIVO <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="customSize">
    ...
    <div class="container-fluid my-5 pe-5">
        <div class="row d-flex justify-content-between">
            <div class="col-12 col-lg-6 d-flex flex-column justify-content-center gap-2 align-items-center">
                <div class="col-8">
                    <div class="border border-dark mb-3 customBorderForMedia">
                        <p class="display-6 p-3">Trasportiamo con efficienza ogni carico</p>
                    </div>
                </div>
                <div class="col-12 col-md-8">
                    <div class="border border-dark mb-3 p-3 customBorderForMedia">
                        <p class="fw-bold">
                ...
                <div class="col-12 col-md-8 ps-3">
                    <div class="row justify-content-center">
                        <div class="d-none col-md-7 d-md-block bgBtn border border-dark">
                        </div>
                        <div class="col-5 col-md-5 ps-0 marginBtnMedia">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6 customMargin position-relative">
    ...
    <div class="container px-5 mb-5 pb-5">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-6 pe-2" data-aos="zoom-out">
    ...
    <div class="container-fluid ps-5 mt-5">
        <div class="row min-vh-25">
            <div class="col-12 lastBtnMedia">
                <h2 class="display-6 mb-4 questForMedia">Vorresti ampliare la tua area di consegna a tutto il territorio nazionale?</h2>
